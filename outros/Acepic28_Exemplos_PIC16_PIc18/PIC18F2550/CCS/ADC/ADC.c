...
*          peratura). Pressionando-se o botão B2, o circuito de aquecimento    *
*          será acionado e o resistor R28 será aquecido até que o sensor leia  *
...
while(true)                   //Loop principal
   {
   if (input(PIN_A4))         //Se pressionado o botão B0
   ...
   printf(lcd_escreve,"\fAN0 = %04lu mV",ad0);    //Mostra valor da conversão do canal 0
