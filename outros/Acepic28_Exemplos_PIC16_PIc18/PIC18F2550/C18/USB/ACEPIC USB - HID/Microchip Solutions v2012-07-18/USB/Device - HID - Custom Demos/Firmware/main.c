...
/** CONFIGURATION **************************************************/
//#if defined(ACEPIC28_USB)      // Configuration bits for PICDEM FS USB Demo Board (based on PIC18F4550)
        #pragma config PLLDIV   = 2         // (Cristal de 8 MHz da placa ACEPIC 28)
...
{   
	...
	//Inicializa os pinos de saída para os LEDs (HardwareProfile - ACEPIC28.h)
	mInitAllLEDs();
	
	//Inicializa os pinos de entrada das chaves (HardwareProfile - ACEPIC28.h)
	mInitAllSwitches();
