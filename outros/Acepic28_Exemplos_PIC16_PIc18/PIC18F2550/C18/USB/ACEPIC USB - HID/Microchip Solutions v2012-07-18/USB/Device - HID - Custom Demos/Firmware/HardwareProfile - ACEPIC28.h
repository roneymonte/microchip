...
#ifndef HARDWARE_PROFILE_ACEPIC28_H
#define HARDWARE_PROFILE_ACEPIC28_H
    ...
    //O dispotivo não será programado por bootloader, assim comentamos
    ...
    /** SWITCH *********************************************************/
    #define mInitAllSwitches()  TRISAbits.TRISA2=1;TRISAbits.TRISA4=1;
    #define mInitSwitch2()      TRISAbits.TRISA2=1;
    #define mInitSwitch3()      TRISAbits.TRISA4=1;
